...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  // Follow the latest descendant of the resume target so dashboard resume
  // jumps to the most recent child session instead of an obsolete parent.
  useEffect(() => {
    ...
    api
      .getSessionLatestDescendant(routeResumeId)
      .then((res) => {
        if (cancelled || !res.session_id || res.session_id === routeResumeId) {
          return;
        }
